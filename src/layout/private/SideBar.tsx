    ...
    <aside id="default-sidebar" className="top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
        <div className="h-full px-3 py-4 overflow-y-auto bg-[#fff]">
            ...
            <ul className="space-y-2 font-medium">
                <li>
                    <NavLink to="/" className="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100">
                    <VscPieChart className="w-6 h-6 text-gray-500 transition duration-75 group-hover:text-gray-900 sidebar-icon"/>
                    <span className="ml-3">Dashboard</span>
                    </NavLink>
                </li>
                <li>
                    <NavLink to="/users" className="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100">
                    <RiUser3Line className="w-6 h-6 text-gray-500 transition duration-75 group-hover:text-gray-900 sidebar-icon"/>
                    <span className="ml-3">Users</span>
                    </NavLink>
                </li>
                <li>
                    <NavLink to="/orders" className="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100">
                    <RiListUnordered className="w-6 h-6 text-gray-500 transition duration-75 group-hover:text-gray-900 sidebar-icon"/>
                    <span className="ml-3">Orders</span>
                    </NavLink>
                </li>
                <li>
                    <NavLink to="/categories" className="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100">
                    <TbLayoutGridAdd className="w-6 h-6 text-gray-500 transition duration-75 group-hover:text-gray-900 sidebar-icon"/>
                    <span className="ml-3">Categories</span>
                    </NavLink>
                </li>
                <li>
                    <NavLink to="/products" className="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100">
                    <BiCartAdd className="w-6 h-6 text-gray-500 transition duration-75 group-hover:text-gray-900 sidebar-icon"/>
                    <span className="ml-3">Products</span>
                    </NavLink>
                </li>
                <li>
                    <NavLink to="/offers" className="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100">
                    <MdOutlineLocalOffer className="w-6 h-6 text-gray-500 transition duration-75 group-hover:text-gray-900 sidebar-icon"/>
                ...
                <li>
                    ...
                    <RiChatHistoryLine className="w-6 h-6 text-gray-500 transition duration-75 group-hover:text-gray-900 sidebar-icon"/>
                ...
                <li>
                    ...
                    <TbDiscountCheck className="w-6 h-6 text-gray-500 transition duration-75 group-hover:text-gray-900 sidebar-icon"/>
