...
const Index = () => {
  ...
  return (
    <div className='h-screen overflow-auto'>
      ...
      <div className='grid grid-cols-3 gap-3 my-3 bg-white p-3'>
        <Link to='/add-product-list' className='flex items-center justify-center text-center mx-auto w-full shadow h-24 rounded bg-orange-500 text-white font-bold'>
          <div>
            <h1>Products</h1>
            <span><CountUp start={0} end={10} duration={3}/></span>
          </div>
        </Link>
        <Link to="/order-list" className='flex items-center justify-center text-center mx-auto w-full shadow h-24 rounded bg-green-500 text-white font-bold'>  
          <div>
            <h1>Orders</h1>
            <span><CountUp start={0} end={5} duration={3}/></span>
          </div>
        </Link>
        <Link to="/user-list" className='flex items-center justify-center text-center mx-auto w-full shadow h-24 rounded bg-red-500 text-white font-bold'>
          <div>
            <h1>Users</h1>
