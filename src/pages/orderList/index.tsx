        ...
        <table className="w-full text-sm text-left text-gray-500">
            ...
            <tbody>
                <tr className="bg-white border-b">
                    ...
                    <td className="px-6 py-4">
                        <select name="" id="">
                            <option className="bg-green-500 rounded p-1 text-white font-medium">Active</option>
                            <option className="bg-red-500 rounded p-1 text-white font-medium">In Active</option>
                        </select>
                    </td>
                    <td className="px-6 py-4">
                        <div className='flex text-xl'>
                            <FiEdit className="text-blue-500 cursor-pointer mx-1"/>
